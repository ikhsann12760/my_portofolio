...
def home():
    projects = [
        ...
        {"title": "Eksperimen Web (Proyek Website Belanja Kita.Id)", "image": "Project_experiment.png", "desc": "Proyek eksplorasi non-komersial untuk pembelajaran dan penguatan skill web untuk mematangkan Pundamental pembuatan Web.", "type": "Pembelajaran menggunakan teknologi Python dan juga Flask"}
    ]
