...
def home():
    projects = [
        ...
        {"title" : "MODERENISASI SPAN2024, SPAN 2025", "image" : "Project Postman.png", "desc": "Project ini bertujuan untuk menguji layanan berbasis Oracle Java menggunakan Postman sebagai tools utama. Pengujian dilakukan untuk memastikan setiap endpoint berjalan sesuai fungsi, format data valid, serta sistem autentikasi dan respons layanan sesuai standar,teknologi yang di gunakan Postman & Bahasa Pemrograman Data JSON"}
    ]
